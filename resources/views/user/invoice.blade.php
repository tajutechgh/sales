        ...
        <div class="printableArea">
            ...
            <div class="pull-left">
              <address>
                ...
                <p class="text-muted m-l-5"><b>Contact:</b> 0241760337,
                  ...
                  <br /><b>Date:</b> {!! Carbon\Carbon::parse($invoice->created_at)->format('d-m-y') !!},
                  <br /><b>Attendant:</b> {!! $invoice->user['name'] !!},
                  <br /><b>Invoice #:</b> {!! $invoice->invoice_number !!}
                </p>
              </address>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="pull-right m-t-30 text-right">
              <h3><b>Total :</b> GH₵ {!! $invoice->total !!}</h3>
            </div>
